...
/**
 * SendWhatsAppIcon SVG icon component.
 *
 * This component renders an SVG representing a whatsapp logo.
 ...
 * @example Custom use
 *  return (
 *   <SendWhatsAppIcon width="40" height="40" color="#000000" fill="#000000" />
 * )
 *
 ...
 * @param {string} props.fill       - The fill color of the path SVG icon.
 * @param {function} props.onClick  - The button functionality.
 * @returns {JSX.Element} The rendered SVG WhatsApp icon.
 */

export const SendWhatsAppIcon = ({
  onClick,
  width = "28",
  height = "28",
  color = "#000",
